...
export default function OurMenu() {
  ...
  return (
    <section>
      ...
      <div
        ref={sectionRef}
        className="w-full flex flex-col md:flex-row md:items-center justify-center gap-0 px-6 md:px-12 my-12"
      >
        {menuItems.map((item, index) => (
          <div
            ...
            key={index}
            className="house-card bg-[#fff] flex flex-col items-center w-60 border-[1px] border-[#EEE9E6] rounded-[0px]"
          >
            <div className="relative w-full h-50 md:h-60 lg:h-60">
